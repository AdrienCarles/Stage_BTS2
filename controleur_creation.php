<?php
    ...
    if($etape == 0 && !isset($_SESSION["type_commande"])){
        echo "<h1>Choisissez un type de commande</h1>";   
        echo "<br>";
        echo "<a href='controleur_creation.php?etape=1&type_commande=W'>Commande WEB</a>";
        echo "<br>";
    ...
    if($etape == 2){
        ...
        foreach($familles as $famille){
          ...
          foreach($images AS $image){  
            ...
            echo("<a href='controleur_creation.php?etape=3&id_famille=".$id_famille."&id_image=".$img."'><img class=' ' src='./img/Visuel/$lib_famille/$img.jpg' alt=''></a>");
          }
          echo "<hr>";
        }
    }
    ...
    if($etape == 4){
        if($message === ''){
            ...
            echo("<img class=' ' src='./img/Visuel/".$famille->get_lib_famille()."/".$image->get_id_image().".jpg' alt='image'>");   
            ?>
            <form action="controleur_validation.php" method="post">
            ...
            header("Location: controleur_validation.php"); //Redirection vers validation
        }
    }
    require("footer.php");
?>